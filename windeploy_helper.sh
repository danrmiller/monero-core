...
if [[ "$BUILD_TYPE" == "Release" ]]; then
	echo "Release build"
	ICU_FILES=(libicudt60.dll libicuin60.dll libicuio60.dll libicutu60.dll libicuuc60.dll)
else
	echo "Debug build"
	ICU_FILES=(libicudtd60.dll libicuind60.dll libicuiod60.dll libicutud60.dll libicuucd60.dll)
fi
